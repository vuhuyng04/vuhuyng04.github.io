...
interface CertificationsClientPageProps {
  certifications: Certificate[];
}

export default function CertificationsClientPage({ certifications }: CertificationsClientPageProps) {
      ...
      <section className="relative bg-gradient-to-br from-blue-900 to-indigo-900 text-white py-24">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-full opacity-5">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="grid-certifications" width="40" height="40" patternUnits="userSpaceOnUse">
                  <path d="M 40 0 L 0 0 0 40" fill="none" stroke={isDark ? "#4F46E5" : "#2563EB"} strokeWidth="1" />
                </pattern>
              </defs>
              <rect width="100%" height="100%" fill="url(#grid-certifications)" />
            </svg>
          </div>
        </div>
        ...
        <div className="absolute inset-0 z-0 opacity-5">
          <svg width="100%" height="100%">
            <pattern
              id="circuit-pattern-certifications"
              x="0"
              y="0"
              width="200"
              height="200"
            ...
            <rect x="0" y="0" width="100%" height="100%" fill="url(#circuit-pattern-certifications)" />
          </svg>
        </div>
